...
export const buttonStyles = ({
  ...
  cn(
    "inline-flex items-center justify-center gap-2 rounded-lg font-bold outline-none transition disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2",
